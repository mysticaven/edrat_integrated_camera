...
export function GitHubIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256" {...props}>
      <path d="M208.31,75.68A59.78,59.78,0,0,0,202.9,28,8,8,0,0,0,196,24a59.75,59.75,0,0,0-44,24c-15.8,0-28.53,6-36,16-7.47-10-20.2-16-36-16A59.75,59.75,0,0,0,36,24a8,8,0,0,0-6.9,4,59.78,59.78,0,0,0-5.41,47.68A59.88,59.88,0,0,0,32,112v8a59.78,59.78,0,0,0,12,36.82_8,8,0,0,0,6.71,3.18,59.6,59.6,0,0,0,24.49-6c16.34,14.5,33.43,22,52.8,22h16c19.37,0,36.46-7.5,52.8-22a59.6,59.6,0,0,0,24.49,6,8,8,0,0,0,6.71-3.18A59.78,59.78,0,0,0,224,120v-8A59.88,59.88,0,0,0,208.31,75.68ZM208,120v4.09c-16.33,0-32.41,6.42-44.52,18.53A8,8,0,0,0,160,152h-64a8,8,0,0,0-3.48-6.38C80.41,130.42,64.33,124.09,48,124.09V120a44.05,44.05,0,0,1,44-44h2.4a8,8,0,0,0,7.17-4.42C106,60.5,116.65,56,128,56s22,4.5,26.43,15.58A8,8,0,0,0,161.6,76H164a44.05,44.05,0,0,1,44,44Z"></path>
    </svg>
  );
}
...
export function ListBulletsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256" {...props}>
...
export function MapTrifoldIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256" {...props}>
...
export function PresentationChartIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256" {...props}>
...
export function ReportsIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <rect x="3" y="4" width="8" height="1.5" rx="0.75" fill="currentColor" opacity="0.7"/>
            <rect x="3" y="6.5" width="6" height="1.5" rx="0.75" fill="currentColor" opacity="0.5"/>
            <rect x="3" y="9" width="5" height="1.5" rx="0.75" fill="currentColor" opacity="0.3"/>
            <rect x="15" y="18" width="6" height="1.5" rx="0.75" fill="currentColor" opacity="0.7"/>
            <rect x="17" y="20.5" width="4" height="1.5" rx="0.75" fill="currentColor" opacity="0.5"/>
        </svg>
    );
}
